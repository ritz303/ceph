...
public:
  ...
  RollbackOp(int n,
    ...
    : TestOp(n, context, stat),
      ...
      done(false), last_finished(-1), outstanding(3)
  {}
  ...
  void _begin()
  {
    ...
    bufferlist bl, bl2;
    zero_write_op1.write(0, bl);
    zero_write_op2.write(0, bl2);
	...
	context->rados.aio_create_completion((void*) cb_arg, NULL,
					     &write_callback));
      context->io_ctx.aio_operate(
	context->prefix+oid, *(comps.rbegin()), &zero_write_op1);
    }
    {
      pair<TestOp*, TestOp::CallbackInfo*> *cb_arg =
	new pair<TestOp*, TestOp::CallbackInfo*>(this,
	...
	context->rados.aio_create_completion((void*) cb_arg, NULL,
					     &write_callback));
      context->io_ctx.aio_operate(
	context->prefix+oid, *(comps.rbegin()), &op);
    }
    if (existed_after) {
      pair<TestOp*, TestOp::CallbackInfo*> *cb_arg =
	new pair<TestOp*, TestOp::CallbackInfo*>(this,
	...
	context->rados.aio_create_completion((void*) cb_arg, NULL,
					     &write_callback));
      context->io_ctx.aio_operate(
	context->prefix+oid, *(comps.rbegin()), &zero_write_op2);
    }
  }
  ...
  void _finish(CallbackInfo *info)
  {
    ...
    if (--outstanding == 0) {
      ...
      context->update_object_version(oid, (*(comps.rbegin()))->get_version64());
      context->oid_in_use.erase(oid);
      context->oid_not_in_use.insert(oid);
