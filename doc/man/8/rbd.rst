...
:command:`du` [-p *pool-name*] [*image-spec* | *snap-spec*]
...
:command:`resize` [--allow-shrink] *image-spec*
...
:command:`import` *src-path* [*image-spec*]
...
:command:`cp` *src-image-spec* *dest-image-spec*
...
:command:`bench-write` [--io-size *io-size-in-bytes*] [--io-threads *num-ios-in-flight*] [--io-total *total-bytes-to-write*] *image-spec*
